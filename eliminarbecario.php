<?php
    ...
    if(isset($_POST['id'])){
        $id = $_POST['id'];
        $query = "DELETE FROM becario WHERE id_becario = $id";
        $respuesta = $conn->query($query);
    }  
    $query = "SELECT b.id_becario, b.nombre, b.apellido, n.etiqueta, tf.etiqueta FROM 
    becario b, nacionalidad n, tipo_formacion tf WHERE n.id_nacionalidad = b.id_nacionalidad AND 
    tf.id_tipo_formacion = b.id_tipo_formacion;";
      ...
      if(isset($respuesta)){
        if(!$respuesta){
          ...
          echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Becario eliminado!</strong> Los datos fueron elimnados con exito.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>';  
